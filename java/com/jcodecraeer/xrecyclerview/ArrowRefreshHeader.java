...
public class ArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader{
	...
	private void initView(Context context) {
		...
		setLoadingDrawable(context.getResources().getDrawable(R.drawable.anim_loading));
...
//                    mArrowImageView.startAnimation(mRotateUpAnim);
    ...
    public void onMove(float delta) {
        if(getVisiableHeight() > 0 || delta > 0) {
            ...
            if (mState <= STATE_RELEASE_TO_REFRESH) { // δ����ˢ��״̬�����¼�ͷ
    ...
    public boolean releaseAction() {
        ...
        if(getVisiableHeight() > mMeasuredHeight/2 &&  mState < STATE_REFRESHING){
