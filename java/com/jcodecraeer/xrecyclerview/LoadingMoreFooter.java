...
public class LoadingMoreFooter extends LinearLayout {
	...
	public void initView(Context context ){
		mContext = context;
		ContextUtil.getLayoutInflater(getContext()).inflate(R.layout.pull_footer_item, this);
...
//	    moreLoading.setVisibility(View.INVISIBLE);
		moreTextEnd.setText(getContext().getResources().getString(R.string.listview_foot));
	}
	...
	public void  setState(int state) {
		switch(state) {
			case STATE_LAODING:
				...
				foot_loading.setVisibility(View.VISIBLE);
				foot_noLoad.setVisibility(View.GONE);
				moreTextEnd.setText(getContext().getResources().getString(R.string.listview_header_last_time));
