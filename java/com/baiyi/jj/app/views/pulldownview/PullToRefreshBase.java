...
import com.baiyi.jj.app.views.pulldownview.internal.FlipLoadingLayout;
import com.baiyi.jj.app.views.pulldownview.internal.LoadingLayout;
import com.baiyi.jj.app.views.pulldownview.internal.RotateLoadingLayout;
import com.baiyi.jj.app.views.pulldownview.internal.Utils;
import com.baiyi.jj.app.views.pulldownview.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public boolean onInterceptTouchEvent(MotionEvent event) {
		...
		switch (action) {
			case MotionEvent.ACTION_MOVE: {
				int deltaX = xx - (int)mLastMotionX;
                int deltaY = yy - (int)mLastMotionY;
				...
				// If we're refreshing, and the flag is set. Eat all MOVE eventsint deltaY = y - mLastMotionY;
	...
	public final void onRefreshPull() {
//		setState(State.REFRESHING);
		mHeaderLayout.pullToRefresh();
	}
	
	public final void setTopRefreshStr(String topStr) {
		mHeaderLayout.setTopRefreshStr(topStr);
	}
	...
	public static interface OnFootRefreshLister<V extends View>
	{
