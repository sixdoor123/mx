package com.baiyi.jj.app.views.video;
...
public class VideoPlayView extends RelativeLayout implements
    ...
    private void initView(Context mContext) {
        ...
        completeLayout = (FrameLayout) findViewById(R.id.complete_layout);
        imgRestart = (ImageView) findViewById(R.id.img_restartt);
    ...
    public void openVideo() {
        ...
        try {
            ...
            mediaPlayer.setLooping(false);//是否进行循环播放
