package com.baiyi.jj.skin.config;

import android.content.Context;

import com.baiyi.jj.skin.util.PreferencesUtils;

public class SkinConfig {
	public  static final String     NAMESPACE 				=   "http://schemas.android.com/android/skin";
	public 	static final String 	SKIN_SUFFIX				= 	".theme";
	public 	static final String 	SKIN_FOLER_NAME 		= 	"skin";
	public 	static final String 	PREF_CUSTOM_SKIN_PATH 	= 	"tk_skin_custom_path";
	public  static final String 	DEFALT_SKIN 			= 	"tk_skin_default";
	public 	static final String 	SKIN_FROM	 			= 	"tk_skin_from";
