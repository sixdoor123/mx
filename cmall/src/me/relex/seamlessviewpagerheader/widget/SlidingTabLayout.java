...
public class SlidingTabLayout extends HorizontalScrollView {
	...
	private static final int TAB_VIEW_PADDING_LEFT_DIPS = 15;
	private static final int TAB_VIEW_TEXT_SIZE_SP = 16;
	private static final int TITLE_SELECT_COLOR = R.color.bg_buyer;
	...
	private int titleColor = TITLE_SELECT_COLOR;
	...
	public void setSelectStripColor(int color) {
	...
	protected TextView createDefaultTabView(Context context) {
		...
		int padding = (int) (TAB_VIEW_PADDING_DIPS * getResources()
				.getDisplayMetrics().density);
		int paddingLeft = (int) (TAB_VIEW_PADDING_LEFT_DIPS * getResources()
				.getDisplayMetrics().density);
