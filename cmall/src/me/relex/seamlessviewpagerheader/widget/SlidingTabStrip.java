...
class SlidingTabStrip extends LinearLayout {
	...
	private static final int DEFAULT_SELECTED_STRIP_COLOR = 0xffec6f1d;
	...
	private int stripSelectColor = DEFAULT_SELECTED_STRIP_COLOR;
	...
	protected void onDraw(Canvas canvas) {
		...
		if (childCount > 0) {
			...
			mSelectedIndicatorPaint.setColor(stripSelectColor);
