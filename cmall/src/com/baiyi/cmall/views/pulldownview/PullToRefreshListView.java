...
import com.baiyi.cmall.views.pulldownview.internal.EmptyViewMethodAccessor;
...
public class PullToRefreshListView extends
	...
	public void addFootView() {
		...
		footView = ContextUtil.getLayoutInflater(getContext()).inflate(
				R.layout.pull_footer_item, null);
	...
	private void initFootView(View footView) {
		ImageView foot_loading = (ImageView) footView
				.findViewById(R.id.foot_loading);
		...
		foot_loading.setImageDrawable(getResources().getDrawable(
				R.drawable.refresh_1));
	...
	public void setShowLine(boolean b) {
		getRefreshableView().setFooterDividersEnabled(b);
	};
