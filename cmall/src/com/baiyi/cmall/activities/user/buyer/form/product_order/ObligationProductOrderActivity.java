 ...
 * 
 */
public class ObligationProductOrderActivity extends
	...
	public void addFoot() {
		...
		View v = ContextUtil.getLayoutInflater(this).inflate(
				R.layout.activity_form_foot, win_content);

		mBtnCommitForm = (TextView) v.findViewById(R.id.btn_commit);
		mBtnCancelForm = (TextView) v.findViewById(R.id.btn_cancel_form);
	...
	public void onClick(View v) {
		...
		case R.id.btn_ok:// 付款成功
			formOpration(BuyNetUrl.getOrderPay(orderID));
			break;
	...
	public void zhiFu() {
		...
		jsonLoader.setUrl(AppNetUrl.getProductZhiFuURL());
		...
		jsonLoader.setLoaderListener(new LoaderListener() {
			...
			public void onCompelete(Object arg0, Object result) {
				...
				OrderEntity entity = MyPurFormManager
						.getMyPurProductFormDetail(array);

				RequestNetResultInfo info = JsonParse_User.getResultInfo(array);
				if (1 == info.getStatus()) {

					Intent intent = new Intent(
							ObligationProductOrderActivity.this,
							PayActivity.class);
