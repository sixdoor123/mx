 ...
 * 
 */
public class MyIntentionOrderViewPager extends BasePageView implements
		OnClickListener, OnCheckedChangeListener {

	private Context context;

	public MyIntentionOrderViewPager(Context context) {
		super(context);
	 ...
	 * ViewPager添加的四个界面
	 */
	private IntentionOrderView orderView1 = null;
	private IntentionOrderView orderView2 = null;
	private IntentionOrderView orderView3 = null;
	private IntentionOrderView orderView4 = null;
	...
	private void initViewPager() {
		...
		orderView1 = new IntentionOrderView(context, 0);
		orderView2 = new IntentionOrderView(context, 1);
		orderView3 = new IntentionOrderView(context, 2);
		orderView4 = new IntentionOrderView(context, 3);
