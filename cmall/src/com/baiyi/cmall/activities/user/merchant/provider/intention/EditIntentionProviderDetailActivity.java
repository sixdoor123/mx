package com.baiyi.cmall.activities.user.merchant.provider.intention;
...
import com.baiyi.cmall.activities.user.merchant.provider.intention.viewpager.BeseEditIntentionProviderViewPager;
import com.baiyi.cmall.activities.user.merchant.provider.intention.viewpager.EditIntentionStandardargDetailViewPager;
import com.baiyi.cmall.activities.user.merchant.provider.intention.viewpager.EditProviderIntentionDetailViewPager;
import com.baiyi.cmall.activities.user.merchant.provider.intention.viewpager.BeseEditIntentionProviderViewPager.OnEditSuccessClickListener;
...
/**
 * 
 * 我是供应商-供应意向-编辑供应详情（包括属性）
 * 
 * @author sunxy
 * @label You can go as far as you want to go.
 * @date 2015-11-16 上午10:40:09
 */
public class EditIntentionProviderDetailActivity extends BaseMsgActivity
		...
		topTitleView.setNewsPopItemOnclick(new NewsPopItemOnclick() {
			...
			public void setNewsPopItemOnclickLister(int state) {
				MsgItemUtil.onclickPopItem(state,
						EditIntentionProviderDetailActivity.this);
			}
		});
	...
	// 供应详情ViewPager
	private BeseEditIntentionProviderViewPager detailsPager;
	// 属性的ViewPager
	private BeseEditIntentionProviderViewPager standardViewPager;
	// 存放ViewPager的集合
	...
	private void initViewPager() {
		...
		detailsPager = new EditProviderIntentionDetailViewPager(this, intentionID, state,
				isEditDetailEnable,isProNameEdit);
		standardViewPager = new EditIntentionStandardargDetailViewPager(this, intentionID,
				isEditDetailEnable);
	...
	public void onClick(View v) {
		...
		case R.id.btn_commit_modify:// 完成
			...
			break;
		case R.id.btn_cancel_modify:// 取消  删除
