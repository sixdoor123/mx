 ...
 */
public abstract class BeseEditIntentionProviderViewPager extends
	...
	public BeseEditIntentionProviderViewPager(Context context, String id) {
		super(context);
	...
	private void loadDatas() {
		...
		loader.setUrl(AppNetUrl.getIntentionProviderDetailEditUrl(id));
	...
	public void editComplete(String intentionID, int idState) {
		...
		JsonLoader loader = new JsonLoader(context);
		loader.setUrl(AppNetUrl.getIntentionProviderDetailEditCompleteUrl(1));
		loader.setPostData(MerchantCenterManager
				.getIntentionProviderDetailEditArg(info,
						ProDataUtils.getDetails(), ProDataUtils.getMap(),
						ProDataUtils.getInfos(), countryInfo, state,
						intentionID, idState, autoStart, autoEnd));
		loader.addRequestHeader("token", token);
		loader.setMethod(BaseNetLoder.Method_Post);
