...
import com.baiyi.cmall.R.string;
 ...
 */
public class EditMyProviderDetailViewPager extends BeseEditMyProviderDetailsViewPager
...
private boolean isProNameEdit;
	public EditMyProviderDetailViewPager(Context context, String id, int state,
			boolean isEditDetailEnable, boolean isProNameEdit) {
		super(context, id);
		this.state = state;
