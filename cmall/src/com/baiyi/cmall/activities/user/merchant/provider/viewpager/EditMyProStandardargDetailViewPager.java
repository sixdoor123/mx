 ...
 */
public class EditMyProStandardargDetailViewPager extends
		BeseEditMyProviderDetailsViewPager implements OnClickListener {

	// 属性数据源
	private ArrayList<IntentionDetailStandardInfo> standDatas;

	public EditMyProStandardargDetailViewPager(Context context, String id,
