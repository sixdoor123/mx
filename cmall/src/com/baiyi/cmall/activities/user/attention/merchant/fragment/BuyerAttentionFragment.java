...
import com.baiyi.cmall.activities.user.attention.BuyerDetailActivity;
 ...
 * @author sunxy
 */
public class BuyerAttentionFragment extends BaseViewPagerFragment implements OnRecycleViewItemClickListener {

	private Context context = null;

	public static BuyerAttentionFragment newInsetence(int index) {
		BuyerAttentionFragment fragment = new BuyerAttentionFragment();
	...
	private void loadData() {
		...
		loader.setUrl(AppNetUrl.getAttentionBuyerUrl( pageIndex, Config.LIST_ITEM_COUNT));
		...
		loader.setLoaderListener(new LoaderListener() {
			...
			public void onCompelete(Object arg0, Object arg1) {
				GoodsSourceInfo info = AttentionManager.getAttentionBuyerListInfo(arg1);
				if (barFlag) {
					loadingBar.stop();
				}
	...
	public <T> void onItemClick(View view, int position, T t) {
		...
		((BaseActivity)context).goActivity(BuyerDetailActivity.class, info.getGoodSID(),info.getUserId());
	}
