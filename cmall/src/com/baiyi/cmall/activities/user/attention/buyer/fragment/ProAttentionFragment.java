 ...
 * @author sunxy
 */
public class ProAttentionFragment extends BaseViewPagerFragment implements OnRecycleViewItemClickListener {
	private Context context = null;

	public static ProAttentionFragment newInsetence(int index) {
		ProAttentionFragment fragment = new ProAttentionFragment();
	...
	private void loadData() {
		...
		loader.setUrl(AppNetUrl.getAttentionProviderUrl(userId, pageIndex, Config.LIST_ITEM_COUNT));
		...
		loader.setLoaderListener(new LoaderListener() {
			...
			public void onCompelete(Object arg0, Object arg1) {
				GoodsSourceInfo info = AttentionManager.getAttentionProviderResultInfo(arg1);
				if (barFlag) {
					loadingBar.stop();
				}
...
//						((BaseActivity) context).displayToast(resultInfo.getMsg());
	...
	public <T> void onItemClick(View view, int position, T t) {
		...
		((BaseActivity) context).goActivity(info, GoodSMainProviderDetailsActivity.class, 1);
	}
