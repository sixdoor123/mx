package com.baiyi.cmall.activities.user.attention.merchant.fragment;
...
import com.baiyi.cmall.activities.user.attention.merchant.adapter.AttentionPurAdapter;
 ...
 * @author sunxy
 */
public class PurAttentionFragment extends BaseViewPagerFragment implements OnRecycleViewItemClickListener {
	private Context context = null;

	public static PurAttentionFragment newInsetence(int index) {
		PurAttentionFragment fragment = new PurAttentionFragment();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View view = ContextUtil.getLayoutInflater(context)//
				.inflate(R.layout.activity_shop_bus, container, false);
		findViewById(view);
		return view;
	}
	...
	private AttentionPurAdapter adapter = null;
	...
	private void findViewById(View view) {
		...
		// 设置adapter
		adapter = new AttentionPurAdapter(context);
	...
	private void loadData() {
		...
		loader.setUrl(AppNetUrl.getAttentionPurchaseUrl(pageIndex, Config.LIST_ITEM_COUNT));
		...
		loader.setLoaderListener(new LoaderListener() {
			...
			public void onCompelete(Object arg0, Object arg1) {
				GoodsSourceInfo info = AttentionManager.getAttentionPurchaseResultInfo(arg1);
				if (barFlag) {
					loadingBar.stop();
				}
...
//						((BaseActivity) context).displayToast(resultInfo.getMsg());
	...
	public <T> void onItemClick(View view, int position, T t) {
		...
		((BaseActivity) context).goActivity(info, PurchaseDetailsActivity.class, 1);
	}
