 ...
 * @author sunxy
 */
public class LogAttentionFragment extends BaseViewPagerFragment implements OnRecycleViewItemClickListener {

	private Context context = null;

	public static LogAttentionFragment newInsetence(int index) {
		LogAttentionFragment fragment = new LogAttentionFragment();
	...
	private AttentionLogisticsAdapter adapter = null;
	...
	private void findViewById(View view) {
		...
		// 设置adapter
		adapter = new AttentionLogisticsAdapter(context);
	...
	private void loadData() {
		...
		loader.setUrl(AppNetUrl.getAttentionLogisticsUrl(pageIndex, Config.LIST_ITEM_COUNT));
		...
		loader.setLoaderListener(new LoaderListener() {
			...
			public void onCompelete(Object arg0, Object arg1) {
				GoodsSourceInfo info = AttentionManager.getAttentionLogisticsResultInfo(arg1);
				if (barFlag) {
					loadingBar.stop();
				}
