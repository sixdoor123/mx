 ...
 * @param <T>
 */
public class AttentionLogisticsAdapter<T> extends BaseRecycleViewAdapter<T> {

	public AttentionLogisticsAdapter(Context context) {
		super(context);
	}
	...
	public void onInitViewHolder(android.support.v7.widget.RecyclerView.ViewHolder viewHolder, int position) {
		...
		holder.formName.setText(TextViewUtil.getEditString(info.getGoodSContactPerson()));
		holder.state.setText(TextViewUtil.getEditString(info.getCompanyName()));
