 ...
 * @param <T>
 */
public class AttentionMerAdapter<T> extends BaseRecycleViewAdapter<T> {

	public AttentionMerAdapter(Context context) {
		super(context);
	}
	...
	public void onInitViewHolder(android.support.v7.widget.RecyclerView.ViewHolder viewHolder, int position) {
		...
		holder.formName.setText(info.getGoodSMerchant());
		holder.state.setText(info.getGoodSContactPerson());
		holder.category.setText(info.getAddress());

		holder.quantity.setText(info.getGoodSContactWay());
