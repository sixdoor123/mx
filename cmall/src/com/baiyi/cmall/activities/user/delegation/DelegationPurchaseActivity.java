 ...
 */
public class DelegationPurchaseActivity extends BaseActivity implements OnRecycleViewItemClickListener {
	...
	private void loadData() {
		...
		loader.setUrl(AppNetUrl.getLogisticsPurchaseListUrl(userID, pageIndex, Config.LIST_ITEM_COUNT));
		...
		loader.setLoaderListener(new LoaderListener() {
			...
			public void onCompelete(Object arg0, Object arg1) {
				GoodsSourceInfo info = UserLogisticsManager
						.getLogisticsPurchaseResultInfo(DelegationPurchaseActivity.this, arg1);
	...
	// 适配器
	private DelegationPurAdapter adapter;
	private View view;
	...
	private void initContent() {
		...
		// 设置adapter
		adapter = new DelegationPurAdapter(this);
	...
	private void initTitle() {
		...
		topTitleView.setNewsPopItemOnclick(new NewsPopItemOnclick() {
			...
			public void setNewsPopItemOnclickLister(int state) {
				MsgItemUtil.onclickPopItem(state, DelegationPurchaseActivity.this);
			}
		});
	...
	public <T> void onItemClick(View view, int position, T t) {
		...
		goActivity(info, DelegationPurchaseDetailsActivity.class);
	}
}
