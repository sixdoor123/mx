 ...
 * @date 2015-12-16 下午2:07:07
 */
public class DelegationPurchaseDetailsActivity extends BaseActivity implements
		OnClickListener {
	...
	private void initTitle() {
		...
		topTitleView.setEventName("委托采购详情");
		...
		topTitleView.setNewsPopItemOnclick(new NewsPopItemOnclick() {
			...
			public void setNewsPopItemOnclickLister(int state) {
				MsgItemUtil.onclickPopItem(state,
						DelegationPurchaseDetailsActivity.this);
			}
		});
	...
	private void loadData() {
		...
		loader.addRequestHeader("token", CmallApplication.getUserInfo()
				.getToken());
		loader.setUrl(AppNetUrl.getLogisticsPurchaseDetailsUrl(id));
		loader.setPostData(UserLogisticsManager.getLogisticsPurDetailPostData());
		...
		loader.setLoaderListener(new LoaderListener() {
			...
			public void onCompelete(Object arg0, Object arg1) {
				info = UserLogisticsManager
						.getLogisticsPurchaseDetailInfo(arg1);
				win_content.removeView(loadingBar);
				loadingBar.stop();
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.btn_commit_modify:// 进入编辑界面
			goActivity(info, EditDelegationPurchaseDetailsActivity.class, 0);
			break;
	...
	private void delete() {
		JsonLoader loader = new JsonLoader(this);
		loader.setUrl(AppNetUrl.getDeleteDelegationPurUril(id));
